...
<header>
    <div class="logo">
        <a href="index.php"><img src="img/logo_black.png" alt="Logo cloudShop"></a>
    </div>
    <nav class="menu-inicial">
        <ul>
            <li><a href="index.php">Inicio<hr></a></li>
    ...
    <nav class="menu-conta">
        <ul>
            ...
            <li><a href="login.php" class="usuario"><img class="i1" src="img/icones/user.png"><img class="i2" src="img/icones/user2.png"></a></li>
